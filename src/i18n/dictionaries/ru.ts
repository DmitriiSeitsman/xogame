...
export const ru = {
  ...
  profileDialog: {
    ...
    descriptionDefault:
      "Можно указать имя — друг увидит его во время игры. Фамилию писать не нужно.",
    descriptionHost:
      "Можно указать имя — друг увидит его во время игры. Если оставить поле пустым, вы будете «Игрок 1». Фамилию писать не нужно.",
    descriptionJoin:
      "Можно указать имя — создатель игры увидит его на экране. Если оставить поле пустым, вы будете «Игрок 2». Фамилию писать не нужно.",
    descriptionRandom:
      "Можно указать имя — соперник увидит его во время игры. Если оставить поле пустым, вы будете «Игрок 1» или «Игрок 2». Лучше не писать настоящее имя целиком.",
    nameLabel: "Имя",
  ...
  strategy: {
    ...
    intro:
      "Короткий ответ: на поле 3×3 выиграть у внимательного соперника нельзя — при точной игре обеих сторон партия всегда заканчивается ничьей. Побеждают за счёт чужих ошибок, а чтобы не ошибаться самому, достаточно знать четыре вещи: силу первого хода, что такое вилка (ход, после которого у вас сразу две возможности собрать ряд — закрыть обе одним ходом соперник не может), в каком порядке выбирать клетки и чем отличаются большие поля.",
