...
export const ru = {
  ...
  cookieBanner: {
    ...
    text: "Мы используем cookies Яндекс Метрики, чтобы видеть статистику посещений. Метрика включится, только если вы согласитесь.",
    more: "Подробнее",
    accept: "Принять",
    decline: "Отклонить",
  },
  ...
  privacy: {
    ...
    intro:
      "Коротко: мы почти ничего о вас не знаем и стараемся так и оставить. Имя указывать необязательно, возраст и контакты мы не спрашиваем, переписка в чате нигде не сохраняется, а статистика Яндекс Метрики включается только с вашего согласия.",
    updated: "Редакция от 21 сентября 2026 года.",
    sections: [
      {
        heading: "Кто отвечает за данные",
        paragraphs: [
          "Сайт xo-game.online создан и поддерживается частным лицом — Дмитрием Сейцманом. По любым вопросам о данных пишите на почту или в Telegram, контакты — в конце страницы.",
        ],
        items: [],
        links: [],
      },
      {
        ...
        paragraphs: [
          "Мы не спрашиваем фамилию, возраст, электронную почту и телефон и не просим регистрироваться. Пожалуйста, не пишите в имени и в чате ничего, по чему вас можно найти.",
        ],
        items: [
          "Имя — только если вы его указали. Оно необязательно: без имени вы будете «Игрок 1» или «Игрок 2». Имя видит ваш соперник в этой партии.",
          "Случайный идентификатор игрока. Браузер создаёт его сам при первом визите и хранит у себя; он не связан с вашей личностью и нужен только для того, чтобы сервер понимал, чьи это ходы.",
          "Данные партии: размер поля, ходы, результат, код приглашения.",
          "Технические данные запросов: IP-адрес и время. Сервер использует их, чтобы ограничивать слишком частые запросы и защищаться от злоупотреблений.",
          "Cookies и данные Яндекс Метрики — только если вы разрешили статистику.",
        ],
        links: [],
      },
      {
        heading: "Чат",
        paragraphs: [
          "Сообщения чата не сохраняются ни в базе данных, ни в журналах. Сервер только передаёт их от одного игрока другому в реальном времени, и после закрытия вкладки их нет нигде. Мы не читаем переписку.",
        ],
        items: [],
        links: [],
      },
      {
        ...
        paragraphs: [],
        items: [
          "Имя стирается через 24 часа после последнего хода в партии.",
          "Запись о партии удаляется через 30 дней после её создания.",
          "Сообщения чата не хранятся вовсе.",
          "Журналы веб-сервера с IP-адресами хранятся не дольше 14 дней.",
          "Идентификатор игрока, имя для подстановки в следующий раз, выбранные тема и язык хранятся только в вашем браузере — их можно удалить, очистив данные сайта.",
        ],
        links: [],
      },
      {
        heading: "Для чего мы используем данные",
        paragraphs: [
          "Мы не продаём данные, не показываем персональную рекламу и не передаём данные третьим лицам, кроме Яндекса — и только если вы разрешили статистику.",
        ],
        items: [
          "Чтобы провести партию и показать сопернику ваше имя и ходы.",
          "Чтобы защитить сервис от злоупотреблений и перегрузки.",
          "С вашего согласия — чтобы считать статистику посещений и делать сайт лучше.",
        ],
        links: [],
      },
      {
        ...
        paragraphs: [
          "Метрика помогает понять, сколько людей заходит на сайт и какими страницами пользуются. Она ставит cookies и получает IP-адрес, тип устройства и браузера и адреса просмотренных страниц. Запись экрана (Вебвизор) выключена.",
          "Метрика загружается только после того, как вы нажмёте «Принять». Изменить решение можно в любой момент ниже на этой странице. Собранные Метрикой данные обрабатывает ООО «Яндекс» по своей политике конфиденциальности.",
        ],
        items: [],
        links: [
          { label: "Политика конфиденциальности Яндекса", href: "https://yandex.ru/legal/confidential/" },
        ],
      },
      {
        heading: "Дети",
        paragraphs: [
          "Игра сделана для детей и взрослых. Мы специально не спрашиваем возраст и не требуем имени. Если ребёнок играет с незнакомым соперником, объясните ему, что в имени и в чате не стоит писать ничего о себе.",
        ],
        items: [],
        links: [],
      },
      {
        heading: "Ваши права",
        paragraphs: [
          "Вы можете узнать, какие данные о вас есть, попросить их удалить или отозвать согласие на статистику. Согласие отзывается кнопкой ниже, остальное — письмом. Укажите примерное время игры и имя, если вы его вводили: иначе мы не сможем понять, какие записи ваши. Отвечаем в течение 10 рабочих дней.",
        ],
        items: [],
        links: [],
      },
    ],
    consentHeading: "Статистика посещений",
    consentGranted: "Сейчас статистика включена.",
    consentDenied: "Сейчас статистика выключена.",
    consentUnset: "Вы ещё не выбрали, поэтому статистика выключена.",
    allow: "Разрешить статистику",
    deny: "Запретить статистику",
    reloading: "Статистика выключена. Перезагружаем страницу, чтобы остановить счётчик…",
