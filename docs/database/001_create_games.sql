...
create table if not exists public.games (
  ...
  player_o_token text,
  player_x_name text,
  player_x_age int check (player_x_age is null or (player_x_age >= 1 and player_x_age <= 120)),
  player_o_name text,
  player_o_age int check (player_o_age is null or (player_o_age >= 1 and player_o_age <= 120)),
